    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            catch (Exception e)
            {
                ...
                messageLbl.Text = "No faces found in the database. Lets register a face!";
            }
        }
        ...
        private void registerbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                messageLbl.ForeColor = Color.Black;
                messageLbl.Text = nameTxt.Text + "´s face detected and added.";
            }
            catch
            {
                messageLbl.ForeColor = Color.Red;
                messageLbl.Text = "Click on the Detect button first.";
            }
        }
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            {
                messageLbl.ForeColor = Color.Red;
                messageLbl.Text = "Multiple faces not allowed.";
            }
